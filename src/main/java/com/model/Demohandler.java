...
public class Demohandler {
	...
	try{
		...
		String fromAddr = "shanjithjoy21.421@gmail.com";
 
		// email subject
		String subject = "jo world wewlcomes you";
 
		// email body
		String body = "Welcome to the jo world "+newuser.getFname()+"."+System.getProperty("line.separator")
